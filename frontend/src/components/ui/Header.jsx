  ...
  return (
    <div className="flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20 ">
      <div className="md:w-1/2 flex flex-col items-center md:items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-white text-left">{t("header.title")}</h2>
        <div className="flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light">
          <img src={assets.group_profiles} alt="group profiles" className="w-28" />
          <p className="text-sm text-white text-center md:text-left">{t("header.subtitle")}</p>
        </div>
        <a href="#speciality">
