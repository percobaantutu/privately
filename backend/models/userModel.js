...
const userSchema = new mongoose.Schema({
  ...
  dob: { // Date of Birth, can be used to calculate age
    type: String, // Consider storing as Date type
    default: "Not Selected",
  },
  phone: {
    type: String,
  ...
  // --- NEW FIELDS TO ADD for student profile information ---
  educationLevel: {
    type: String,
    default: "Not Specified", // Or some other sensible default
  },
  learningGoals: {
